...
Ref<Mesh> CreateRectXY(const Transform& tf, const Ref<Material> mat, const UV& texCoord)
{
    ...
    Vertex v0{ p0, z_axis, x_axis, UV(0.0, 0.0) };
    Vertex v1{ p1, z_axis, x_axis, UV(texCoord.x, 0.0) };
    Vertex v2{ p2, z_axis, x_axis, UV(texCoord.x, texCoord.y) };
...
Ref<Mesh> CreateRectXZ(const Transform& tf, const Ref<Material> mat, const UV& texCoord)
{
    ...
    Vertex v0{ p0, y_axis, x_axis, UV(0.0, 0.0) };
    Vertex v1{ p1, y_axis, x_axis, UV(texCoord.x, 0.0) };
    Vertex v2{ p2, y_axis, x_axis, UV(texCoord.x, texCoord.y) };
...
Ref<Mesh> CreateRectYZ(const Transform& tf, const Ref<Material> mat, const UV& texCoord)
{
    ...
    Vertex v0{ p0, x_axis, -z_axis, UV(0.0, 0.0) };
    Vertex v1{ p1, x_axis, -z_axis, UV(texCoord.x, 0.0) };
    Vertex v2{ p2, x_axis, -z_axis, UV(texCoord.x, texCoord.y) };
...
Ref<Mesh> CreateBox(const Transform& tf, const Ref<Material> mat, const UV& texCoord)
{
    ...
    */
    ...
    Vertex v00 = { p0, z_axis, x_axis, UV(0.0, 0.0) };
    Vertex v01 = { p1, z_axis, x_axis, UV(texCoord.x, 0.0) };
    Vertex v02 = { p2, z_axis, x_axis, UV(texCoord.x, texCoord.y) };
    Vertex v03 = { p3, z_axis, x_axis, UV(0.0, texCoord.y) };

    Vertex v04 = { p1, x_axis, -z_axis, UV(0.0, 0.0) };
    Vertex v05 = { p5, x_axis, -z_axis, UV(texCoord.x, 0.0) };
    Vertex v06 = { p6, x_axis, -z_axis, UV(texCoord.x, texCoord.y) };
    Vertex v07 = { p2, x_axis, -z_axis, UV(0.0, texCoord.y) };

    Vertex v08 = { p5, -z_axis, -x_axis, UV(0.0, 0.0) };
    Vertex v09 = { p4, -z_axis, -x_axis, UV(texCoord.x, 0.0) };
    Vertex v10 = { p7, -z_axis, -x_axis, UV(texCoord.x, texCoord.y) };
    Vertex v11 = { p6, -z_axis, -x_axis, UV(0.0, texCoord.y) };

    Vertex v12 = { p4, -x_axis, z_axis, UV(0.0, 0.0) };
    Vertex v13 = { p0, -x_axis, z_axis, UV(texCoord.x, 0.0) };
    Vertex v14 = { p3, -x_axis, z_axis, UV(texCoord.x, texCoord.y) };
    Vertex v15 = { p7, -x_axis, z_axis, UV(0.0, texCoord.y) };

    Vertex v16 = { p3, y_axis, x_axis, UV(0.0, 0.0) };
    Vertex v17 = { p2, y_axis, x_axis, UV(texCoord.x, 0.0) };
    Vertex v18 = { p6, y_axis, x_axis, UV(texCoord.x, texCoord.y) };
    Vertex v19 = { p7, y_axis, x_axis, UV(0.0, texCoord.y) };

    Vertex v20 = { p1, -y_axis, -x_axis, UV(0.0, 0.0) };
    Vertex v21 = { p0, -y_axis, -x_axis, UV(texCoord.x, 0.0) };
    Vertex v22 = { p4, -y_axis, -x_axis, UV(texCoord.x, texCoord.y) };
    Vertex v23 = { p5, -y_axis, -x_axis, UV(0.0, texCoord.y) };
