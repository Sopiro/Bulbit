...
{
    {
        auto mat = scene.CreateMaterial<UnrealMaterial>(
            ConstantColorTexture::Create(1.0), ConstantFloatTexture::Create(1.0f), ConstantFloatTexture::Create(0.1f)
        );
    ...
    {
        auto mat = scene.CreateMaterial<UnrealMaterial>(
            ConstantColorTexture::Create(1.0f), ConstantFloatTexture::Create(0.0f), ConstantFloatTexture::Create(0.01f)
        );
