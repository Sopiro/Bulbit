...
{
    {
        auto mat = scene.CreateMaterial<UnrealishMaterial>(ConstantColorTexture::Create(1.0), ConstantFloatTexture::Create(1.0f),
    ...
    // Floor
    {
        auto mat = scene.CreateMaterial<UnrealishMaterial>(ConstantColorTexture::Create(1.0f), ConstantFloatTexture::Create(0.0f),
