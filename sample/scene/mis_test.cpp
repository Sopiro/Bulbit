...
{
    {
        auto floor_mat = scene.CreateMaterial<Microfacet>(ConstantColorTexture::Create(0.4f), ConstantFloatTexture::Create(0.0f),
    ...
    {
        auto m1 =
            scene.CreateMaterial<Microfacet>(ConstantColorTexture::Create(Spectrum(0.07f, 0.09f, 0.13f)),
...
{
    {
        auto floor = scene.CreateMaterial<Microfacet>(ColorImageTexture::Create("res/wakdu.jpg"),
