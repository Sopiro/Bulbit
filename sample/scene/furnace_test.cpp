...
std::unique_ptr<Camera> FurnaceConductor(Scene& scene)
{
    ...
    outers[3] = CreateConductorMaterial(scene, Spectrum(1), 0.0f);
    outers[1] = CreateConductorMaterial(scene, Spectrum(1), 0.25f);
    outers[0] = CreateConductorMaterial(scene, Spectrum(1), 0.5f);
    outers[2] = CreateConductorMaterial(scene, Spectrum(1), 0.75f);
    outers[4] = CreateConductorMaterial(scene, Spectrum(1), 1.0f);
...
std::unique_ptr<Camera> FurnaceDielectric(Scene& scene)
{
    ...
    outers[3] = CreateDielectricMaterial(scene, ior, Spectrum(1), 0.0f);
    outers[1] = CreateDielectricMaterial(scene, ior, Spectrum(1), 0.25f);
    outers[0] = CreateDielectricMaterial(scene, ior, Spectrum(1), 0.5f);
    outers[2] = CreateDielectricMaterial(scene, ior, Spectrum(1), 0.75f);
    outers[4] = CreateDielectricMaterial(scene, ior, Spectrum(1), 1.0f);
...
static int32 index1 = Sample::Register("furnace2", FurnaceConductor);
static int32 index2 = Sample::Register("furnace3", FurnaceDielectric);