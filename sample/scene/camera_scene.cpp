...
std::unique_ptr<Camera> CameraScene(Scene& scene)
{
    // Floor
    {
        auto mat = scene.CreateMaterial<UnrealMaterial>(ConstantColorTexture::Create(Spectrum(0.5f)),
                                                        ConstantFloatTexture::Create(0.0f), ConstantFloatTexture::Create(0.01f));
