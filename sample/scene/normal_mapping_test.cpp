...
void NormalMapping(Scene& scene)
{
    ...
    // Ref<Model> model = SharedRef<Model>("res/pbr_kabuto_samurai_helmet/scene.gltf", transform);
    ...
    // scene.SetDirectionalLight(CreateSharedRef<DirectionalLight>(-Vec3{ -1, 10, 0 }.Normalized(), Vec3{ 1.0 }));
