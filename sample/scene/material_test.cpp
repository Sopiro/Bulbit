...
std::unique_ptr<Camera> MaterialTest6(Scene& scene)
{
    ...
    outers[3] = CreatePrincipledMaterial(scene, { 0.9f, 0.5f, 0.3f }, 1.0f, 0.5f, 0.0f, 1.5f, 0.0f, 0.0f, 0.03f);
    outers[1] = CreatePrincipledMaterial(scene, { 0.9f, 0.5f, 0.3f }, 1.0f, 0.5f, 0.0f, 1.5f, 0.0f, 0.25f, 0.03f);
    outers[0] = CreatePrincipledMaterial(scene, { 0.9f, 0.5f, 0.3f }, 1.0f, 0.5f, 0.0f, 1.5f, 0.0f, 0.5f, 0.03f);
    outers[2] = CreatePrincipledMaterial(scene, { 0.9f, 0.5f, 0.3f }, 1.0f, 0.5f, 0.0f, 1.5f, 0.0f, 0.75f, 0.03f);
    outers[4] = CreatePrincipledMaterial(scene, { 0.9f, 0.5f, 0.3f }, 1.0f, 0.5f, 0.0f, 1.5f, 0.0f, 1.0f, 0.03f);

    // outers[3] = CreateDielectricMaterial(scene, 1.0f, Spectrum(1), 0.1f);
    // outers[1] = CreateDielectricMaterial(scene, 1.25f, Spectrum(1), 0.1f);
    // outers[0] = CreateDielectricMaterial(scene, 1.5f, Spectrum(1), 0.1f);
    // outers[2] = CreateDielectricMaterial(scene, 1.75f, Spectrum(1), 0.1f);
    // outers[4] = CreateDielectricMaterial(scene, 2.0f, Spectrum(1), 0.1f);
...
std::unique_ptr<Camera> MaterialTest7(Scene& scene)
{
    HomogeneousMedium* hm = scene.CreateMedium<HomogeneousMedium>(Spectrum(0, 0, 0), Spectrum(10), Spectrum(0.0), -0.9f);
    MediumInterface mi(hm, nullptr);
    ...
    for (int32 j = 0; j < h; ++j)
    {
        for (int32 i = 0; i < w; ++i)
        {
            ...
            auto tf = Transform{ p + Vec3(0, 0.0f, 0), Quat::FromEuler({ 0, pi, 0 }), Vec3(scale) };
...
static int32 index7 = Sample::Register("material7", MaterialTest7);
static int32 index8 = Sample::Register("material8", ColoredDielectrics);
