...
std::unique_ptr<Camera> FurnaceConductor2(Scene& scene)
{
    ...
    outers[9] = CreateConductorMaterial(scene, Spectrum(1), 0.0f, energy_compensation);
    outers[7] = CreateConductorMaterial(scene, Spectrum(1), 0.1f, energy_compensation);
    outers[5] = CreateConductorMaterial(scene, Spectrum(1), 0.2f, energy_compensation);
    outers[3] = CreateConductorMaterial(scene, Spectrum(1), 0.3f, energy_compensation);
    outers[1] = CreateConductorMaterial(scene, Spectrum(1), 0.4f, energy_compensation);
    outers[0] = CreateConductorMaterial(scene, Spectrum(1), 0.5f, energy_compensation);
    outers[2] = CreateConductorMaterial(scene, Spectrum(1), 0.6f, energy_compensation);
    outers[4] = CreateConductorMaterial(scene, Spectrum(1), 0.7f, energy_compensation);
    outers[6] = CreateConductorMaterial(scene, Spectrum(1), 0.8f, energy_compensation);
    outers[8] = CreateConductorMaterial(scene, Spectrum(1), 0.9f, energy_compensation);
    outers[10] = CreateConductorMaterial(scene, Spectrum(1), 1.0f, energy_compensation);
